...
async def get_fire_detail(
    ...
    if tri is not None:
        ...
        triage_detail = TriageDetail(
            ...
            fuel_moisture_10h_pct=tri.get("fuel_moisture_10h_pct"),
            fuel_moisture_100h_pct=tri.get("fuel_moisture_100h_pct"),
            fuel_moisture_live_h_pct=tri.get("fuel_moisture_live_h_pct"),
            fuel_moisture_live_w_pct=tri.get("fuel_moisture_live_w_pct"),
            scenarios=scenarios,
            notes=tri["notes"] or [],
        )
